  ...
  fields: [
    {
      ...
      options: {
        list: [
          { title: '🏞  Grande photo d\'accueil (haut de page)', value: 'hero' },
          { title: '🧘  Cours collectif — photo 1',              value: 'cours-collectif-1' },
          { title: '🤸  Cours collectif — photo 2',              value: 'cours-collectif-2' },
          { title: '🏛  Salle — vue d\'ensemble',                 value: 'salle-ensemble' },
          { title: '🧘‍♀️  Salle — tapis',                          value: 'salle-tapis' },
          { title: '💬  Bandeau d\'appel à l\'action',            value: 'cta-banner' },
          { title: '👤  Photo « À propos »',                      value: 'about' },
        ],
      },
